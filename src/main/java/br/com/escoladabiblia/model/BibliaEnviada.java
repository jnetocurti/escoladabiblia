...
@Entity
@Table(name = "biblias_enviadas")
public class BibliaEnviada implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BibliaEnviada other = (BibliaEnviada) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public String toString() {
		return "BibliaEnviada [postagem=" + postagem + ", atividadeEstudo=" + atividadeEstudo + "]";
	}

	/**
	 * Creates builder to build {@link BibliaEnviada}.
	 * 
	...
	/**
	 * Builder to build {@link BibliaEnviada}.
	 */
	@Generated("SparkTools")
	public static final class Builder {
		...
		public BibliaEnviada build() {
			return new BibliaEnviada(this);
		}
	}
