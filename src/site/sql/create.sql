...
create table atividades_estudo (id  bigserial not null, data_envio_estudo date not null, data_retorno_estudo date, envio_biblia boolean, envio_certificado boolean, nota float4, aluno_id int8 not null, material_id int8 not null, primary key (id))
create table atividades_postagem (postagem_id int8 not null, atividade_id int8 not null)
...
create table materiais_estudo (id  bigserial not null, envia_certificado boolean not null, nome varchar(100) not null, qtd_estoque int4, primary key (id))
create table postagens (id  bigserial not null, data_postagem date not null, postado boolean not null, primary key (id))
...
alter table atividades_postagem add constraint atividades_postagem_uk unique (atividade_id)
...
alter table atividades_postagem add constraint atividade_fk foreign key (atividade_id) references atividades_estudo
alter table atividades_postagem add constraint postagem_fk foreign key (postagem_id) references postagens
